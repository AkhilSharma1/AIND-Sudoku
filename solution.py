...
#add diagonal units
diagonal_units = [[x+y for x,y in zip(rows, cols)]]
rev_diagonal_units = [[x+y for x,y in zip(rows, cols[::-1])]]


unitlist = row_units + column_units + square_units + diagonal_units + rev_diagonal_units
